...
-- | Dynamic user interface element control. This CSS3 functionality
-- is still in draft, though it is implemented in several
-- browsers. See
-- <http://www.w3.org/TR/2000/WD-css3-userint-20000216#dynamic> and
...
newtype UserFocus = UserFocus Value
  deriving (Val,Inherit,None,Normal)
